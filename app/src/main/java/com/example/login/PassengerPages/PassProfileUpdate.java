...
public class PassProfileUpdate extends AppCompatActivity {
    private static final String TAG = "PassProfileUpdate";

    EditText fnameTv, lnameTv, phoneTV, addressTv;
    TextView update;
    ...
    Context mContext = PassProfileUpdate.this;
    String user_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pass_profile_update);
        ...
        databaseReference = mReference.child("All Passengers").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
    ...
    private void getUser_Profile_Data() {
        ...
        mReference.child("All Passengers").child(FirebaseAuth.getInstance().getCurrentUser().getUid())
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference imagePath = mStorage.child(getString(R.string.all_passenger)).child(user_id).child("profile.jpg");
                ...
                imagePath.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        imagePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                final String downloadurl = uri.toString();
                                mReference.child(getString(R.string.all_passenger)).child(user_id).child("userDp").setValue(downloadurl);
                            }
                        });
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(PassProfileUpdate.this, "Failed" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
