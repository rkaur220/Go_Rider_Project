...
import com.example.login.Fragments.UsersFragment2;
...
public class PassRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pass_rating);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                viewPagerAdapter.addFragment(new UsersFragment2(), "Drivers");
